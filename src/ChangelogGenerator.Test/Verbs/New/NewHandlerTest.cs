    ...
    public class NewHandlerTest
    {
        ...
        public void TestRun()
        {
            ...
            IDictionary<string, IList<string>> changelogEntries = new Dictionary<string, IList<string>>
                                                                  {
                                                                      {"added", new List<string>{"an added entry"}},
                                                                      {"changed", new List<string>{"a changed entry"}},
                                                                      {"deprecated", new List<string>{"a deprecated entry"}},
                                                                      {"fixed", new List<string>{"a fixed entry"}},
                                                                      {"removed", new List<string>{"a removed entry"}},
                                                                      {"security", new List<string>{"a security entry"}},
                                                                  };
            ...
            fileSystem.Verify(mock => mock.File.WriteAllTextAsync("CHANGELOG.md", changelogText, It.IsAny<CancellationToken>()), Times.Once);
